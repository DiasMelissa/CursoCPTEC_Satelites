# Seventh Script of training on Python how to plot GOES-R Imagery: Script 07 - RGB Creation
#-----------------------------------------------------------------------------------------------------------
# Required modules
...
file1 = Dataset("OR_ABI-L2-CMIPC-M6C08_G16_s20230770001175_e20230770003548_c20230770004063.nc")
# Get the pixel values, and convert to Celsius
data1 = file1.variables['CMI'][:,:][::4 ,::4] - 273.15
# Open the GOES-R image
file2 = Dataset("OR_ABI-L2-CMIPC-M6C10_G16_s20230770001175_e20230770003564_c20230770004087.nc")
# Get the pixel values, and convert to Celsius
data2 = file2.variables['CMI'][:,:][::4 ,::4] - 273.15
# Open the GOES-R image
file3 = Dataset(" OR_ABI-L2-CMIPC-M6C12_G16_s20230770001175_e20230770003553_c20230770004045.nc")
# Get the pixel values, and convert to Celsius
data3 = file3.variables['CMI'][:,:][::4 ,::4] - 273.15
# Open the GOES-R image
file4 = Dataset("OR_ABI-L2-CMIPC-M6C13_G16_s20230770001175_e20230770003560_c20230770004066.nc")
# Get the pixel values, and convert to Celsius
