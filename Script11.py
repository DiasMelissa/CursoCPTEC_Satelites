# Eleventh Script of training on Python how to plot GOES-R Imagery: Script 11 - Downloading data from AWS (function)
#-----------------------------------------------------------------------------------------------------------
# Required modules
...
# Define the color scale based on the chanel
